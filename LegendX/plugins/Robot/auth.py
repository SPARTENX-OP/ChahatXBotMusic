...
from LegendX.utils.database import (delete_authuser, get_authuser,
                                       get_authuser_names,
                                       save_authuser)
from LegendX.utils.decorators import AdminActual
from LegendX.utils.formatters import int_to_alpha
...
async def auth(client, message: Message, _):
    if not message.reply_to_message:
        ...
        if token not in _check:
            ...
            await message.reply_sticker("NIKAL")
